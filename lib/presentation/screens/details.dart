                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Positioned(
                            top: -50,
                            left: -50,
                            child: Image.asset("assets/images/pngs/" +
                          ...
                          Positioned(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "Tomorrow: ${getForecastWeather(0)["weatherName"]}",
                                  style: TextStyle(
                                    fontSize: 20,
                                    color: Colors.white,
                                  ),
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                value: getForecastWeather(0)["chanceOfRain"],
                                  unit: "%",
                                  imageUrl: "assets/images/pngs/lightrain.png",
                                ),
                              ]),
                            ),
                          ),
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Image.asset(
                                                  "assets/images/pngs/lightrain.png",
                                                  width: 30, 
                                                ),
                                              ...
                                              Row(
                                                children: [
                                                  Row(
                                                    children: [
                                                      Text(
                                                        getForecastWeather(1)["minTemperature"].toString(),
                                                        style: TextStyle(
                                                          color: _constants.greyColor,
                                                          fontSize: 30,
                                                          fontWeight: FontWeight.w600,
                                                  ...
                                                  Row(
                                                    children: [
                                                      Text(
                                                        getForecastWeather(1)["maxTemperature"].toString(),
                                                        style: TextStyle(
                                                          color: _constants.blackColor,
                                                          fontSize: 30,
                                                          fontWeight: FontWeight.w600,
                                              ...
                                              Row(
                                                children: [
                                                  Row(
                                                    children: [
                                                      Text(
                                                        getForecastWeather(2)["minTemperature"].toString(),
                                                        style: TextStyle(
                                                          color: _constants.greyColor,
                                                          fontSize: 30,
                                                          fontWeight: FontWeight.w600,
                                                  ...
                                                  Row(
                                                    children: [
                                                      Text(
                                                        getForecastWeather(2)["maxTemperature"].toString(),
                                                        style: TextStyle(
                                                          color: _constants.blackColor,
                                                          fontSize: 30,
                                                          fontWeight: FontWeight.w600,
